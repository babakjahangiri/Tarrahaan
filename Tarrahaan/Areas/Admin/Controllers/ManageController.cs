...
namespace Tarrahaan.Areas.Admin.Controllers
{
    ...
    [RoutePrefix(@"{lang:regex([a-zA-Z]{2})}/Manage")]
    [Localization]
    public class ManageController : Controller
    {
        ...
        //
        // GET: WebAdmin/en/Manage/ChangePassword
        [Route("ChangePassword", Name = "ChangePasswordRoute")]
        public ActionResult ChangePassword(ManageMessageId? message)
        {
            ViewBag.Message = (message == ManageMessageId.ChangePasswordSuccess ? "Your password has been changed." : "");
           
               return View();
        }

        //
        // POST: /en/Manage/ChangePassword
        [Route("ChangePassword", Name = "ChangePasswordPostRoute")]
        [HttpPost]
        ...
        [Route("SetPassword", Name = "SetPasswordRoute")]
        ...
        [HttpPost]
        [Route("SetPassword", Name = "SetPasswordPostRoute")]
        [ValidateAntiForgeryToken]
